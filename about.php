...
<body>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">We are <span>The <Br>Sports World</span></h2>
                    <p>"We Provide Better Sports Essentials So That You Can Enjoy Every Moment"
                </div>
                <div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-thumbnail img-fluid" src="images/about-img.png" alt="" />
                    </div>
                </div>
            </div>
            </div>
