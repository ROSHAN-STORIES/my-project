            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="tennis.php">Tennis</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="card" >
                    <img src="images/racket 3.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Racket</b></h5>
                      <p class="card-text">Price Rs 499</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Racket">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/racket 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Racket</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/racket 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Racket</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/racket 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Racket</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis ball 6.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Ball</b></h5>
                      <p class="card-text">Price Rs 55</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Ball">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis ball 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Ball</b></h5>
                      <p class="card-text">Price Rs 49</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Ball">
                      <input type="hidden" name="Price" value="55">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis ball 7.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Ball</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis ball 8.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Ball</b></h5>
                      <p class="card-text">Price Rs 39</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Ball">
                      <input type="hidden" name="Price" value="55">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis net 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Net</b></h5>
                      <p class="card-text">Price Rs 349</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Net">
       ...
       <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis net 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Net</b></h5>
                ...
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis net 3.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Net</b></h5>
                      <p class="card-text">Price Rs 319</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Net">
                      <input type="hidden" name="Price" value="349">
                    </div>
                ...
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/tennis net.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Tennis Net</b></h5>
                      <p class="card-text">Price Rs 309</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="Tennis Net">
                      <input type="hidden" name="Price" value="349">
                    </div>
