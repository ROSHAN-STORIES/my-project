            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="football.php">Football</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="card" >
                    <img src="images/encounter shoe 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Encounter shoe</b></h5>
                      <p class="card-text">Price Rs 799</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value=" encounter Shoes">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/encounter shoe 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Encounter shoe</b></h5>
                      <p class="card-text">Price Rs 749</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value=" encounter Shoes">
                      <input type="hidden" name="Price" value="799">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/encounter shoe 3.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Encounter shoe</b></h5>
                      <p class="card-text">Price Rs 719</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value=" encounter Shoes">
                      <input type="hidden" name="Price" value="799">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/encounter shoe 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Encounter shoe</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/soccer ball 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Soccer ball</b></h5>
                      <p class="card-text">Price Rs 550</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="soccer ball">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/soccer ball 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Soccer ball</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/soccer ball 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Soccer ball</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/soccer ball 3.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Soccer ball</b></h5>
                      <p class="card-text">Price Rs 490</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="soccer ball">
                      <input type="hidden" name="Price" value="550">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/football jersey 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/football jersey 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>T-Shirt</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/football jersey 3.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>T-Shirt</b></h5>
                      <p class="card-text">Price Rs 119</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value="T Shirt">
                      <input type="hidden" name="Price" value="149">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src="images/football jersey 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>T-Shirt</b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src=" images/trousers.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Trousers </b></h5>
                      <p class="card-text">Price Rs 199</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value= "Trousers">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src=" images/football trouser 1.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Trousers </b></h5>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src=" images/football trouser 2.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Trousers </b></h5>
                      <p class="card-text">Price Rs 159</p>
                      <button type="submit" name="Add_To_Cart" class="btn btn-success">Add to Cart</button>
                      <input type="hidden" name="Item_Name" value= "Trousers">
                      <input type="hidden" name="Price" value="199">
                    </div>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                <div class="card" >
                    <img src=" images/football trouser 4.jpg" class="card-img-top">
                    <div class="card-body text-center">
                      <h5 class="card-title"><b>Trousers </b></h5>
