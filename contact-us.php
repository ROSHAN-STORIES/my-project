                                        ...
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="tennis.php.php">Wrist And Hand Bands</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-menu col-md-3">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: 7, P.N Road<br>Bhandup(West)<br> Mumbai-400078</p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+91-1234567890">+91-1234567890</a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a href="mailto:roshanyadav2101@gmail.com">contactinfo@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>SEND FEEDBACK</h2>
                        <p>You Can Share Your Thoughts With Us</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                        <button class="btn hvr-hover" id="submit" name="fsave" type="submit">Send Message</button>
                                        <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <?php
                                     if(isset($_SESSION['fgh'])){
                                        echo $_SESSION['fgh'];
                                        unset($_SESSION['fgh']);
                                        }
                                    ?>
